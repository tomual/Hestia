...
def create_thread(thread_title, thread_content, days):
    time = timezone.now() + datetime.timedelta(days=days)
    return Thread.objects.create(thread_title=thread_title, thread_content=thread_content, thread_date=time)
